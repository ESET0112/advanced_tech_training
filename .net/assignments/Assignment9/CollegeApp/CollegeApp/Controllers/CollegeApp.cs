...
namespace CollegeApp.Controllers
{
    ...
    public class CollegeApp : ControllerBase
    {
        ...
        public async Task<ActionResult> CreateEmployee([FromBody] CourseDTO courseDto)
        {
            if (courseDto == null)
            {
        ...
        public async Task<ActionResult> UpdateEmployee(int id, [FromBody] CourseDTO courseDto)
        {
            if (courseDto == null)
            {
                return BadRequest("Course data cannot be null");
