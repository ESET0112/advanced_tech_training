...
namespace CollegeApp.Controllers
{
    ...
    public class CollageApp : ControllerBase
    {
        ...
        public CollageApp(IstudentRepository mystudent)
        {
            _dbcontext = mystudent;
        }
        ...
        {
            var students = await _dbcontext.GetAll();
            return Ok(students);
        ...
        public async Task<ActionResult<List<Student>>> GetStudentsbyId(int id)
        {
            ...
            var students = await _dbcontext.getstudentsbyid(id);
        ...
        {
            var students = await _dbcontext.getstudentsbyname(name);
            return Ok(students);
        ...
        {
            var result = await _dbcontext.createstudent(student);
            return Ok(result);
        }
        ...
        {
            var result = await _dbcontext.updatestudent(student);
            return Ok(result);
        }
        ...
        {
            var remove = await _dbcontext.deletestudent(id);
            return Ok(true);
        }
