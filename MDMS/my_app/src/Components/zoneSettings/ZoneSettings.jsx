    ...
    return (
        <div className='mb-8'>
            <div className='justify-items-start mb-6'>
                <h2 className='font-bold text-2xl'>Alert Thresholds</h2>
            </div>
            <div className='justify-items-start'>
                <h2 className='text-xl'>Set consumption limits that trigger automatic alerts for meters in your zone.</h2>
            </div>
